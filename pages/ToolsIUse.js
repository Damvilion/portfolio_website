    ...
    <div>
      ...
      <div className="flex items-center justify-center">
        ...
        <div
          ref={slider}
          id="slider"
          className="flex flex-wrap flex-col items-center gap-2 w-full snap-x md:flex-row scrollbar-hide lg:w-full lg:h-full md:overflow-x-auto md:scroll-smooth md:whitespace-nowrap lg:p-1 md:flex-nowrap"
        >
          ...
          <div className="snap-center">
            <div className=" text-center shadow-lg rounded-xl my-10 hover:shadow-2xl duration-100 hover:translate-y-1">
              ...
              <div className="py-2 mx-2">
                ...
                <p>
                  By leveraging its extensive collection of utility classes,
                </p>
                <p>
